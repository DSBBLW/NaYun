...
public class Peoples {
    ...
    private String eid;//社区id
    private String address;//详细地址
    private String cause;//救助原因
    private String picture;//图片路径
    private String comment;//备注
    private String idp;//省id
    private String idc;//市id
    private String idt;//县id
    ...
    public String getAreans() {
        return areans;
    }

    public void setAreans(String areans) {
        this.areans = areans;
    }
